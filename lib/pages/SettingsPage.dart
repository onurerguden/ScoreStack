                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Material(
                          color: Colors.transparent,
                          child: InkWell(
                            onTap: () => launchUrl(Uri.parse('https://www.yesilay.org.tr')),
                            splashColor: Colors.white24,
                            highlightColor: Colors.white10,
                            child: ListTile(
                              leading: Icon(Icons.volunteer_activism, color: Colors.tealAccent),
                              title: Text(
                                'Yeşilay - Türkiye',
                                style: TextStyle(color: Colors.white),
                              ),
                      ...
                      Container(
                        ...
                        child: Material(
                          color: Colors.transparent,
                          child: InkWell(
                            onTap: () => launchUrl(Uri.parse('https://www.begambleaware.org')),
                            splashColor: Colors.white24,
                            highlightColor: Colors.white10,
                            child: ListTile(
                      ...
                      Container(
                        ...
                        child: Material(
                          color: Colors.transparent,
                          child: InkWell(
                            onTap: () => launchUrl(Uri.parse('https://www.gamblingtherapy.org')),
                            splashColor: Colors.white24,
                            highlightColor: Colors.white10,
                            child: ListTile(
                      ...
                      Container(
                        ...
                        child: Material(
                          color: Colors.transparent,
                          child: InkWell(
                            onTap: () => launchUrl(Uri.parse('https://www.responsiblegambling.org')),
                            splashColor: Colors.white24,
                            highlightColor: Colors.white10,
                            child: ListTile(
                              leading: Icon(Icons.shield, color: Colors.deepPurpleAccent),
                              title: Text(
